...
namespace TechnologyTests
{
    ...
    public class SmartPhoneTests
    {
        ...
        public void CreateSmartPhoneObject()
        {
            ...
            test_smartphone2 = new SmartPhone("IPhone 11", "Steve", 2019, 8.0, "iOS", false, "T-Mobile"); // the AbStractEntity ID, name, owner, yearMade, ram, operatingSystem, deviceStatus
        }

        [TestMethod]
        public void TestSettingDeviceId()
        {
            Assert.IsFalse(test_smartphone1.DeviceId == test_smartphone2.DeviceId); //Ids are NOT equal
        ...
        {
            Assert.IsFalse(test_smartphone2.DeviceStatus);
        }
        [TestMethod]
